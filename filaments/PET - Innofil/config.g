...
M302 S180 R120				    ; set limits for cold extrusion (Allow extrusion starting from 160°C and retractions already from 90°C)
...
if state.currentTool == 0
	M207 P0 S3 F2400 T1200 Z1.25
elif state.currentTool == 1
	M207 P1 S4 F2800 T1400 Z0.25
elif state.currentTool == 2
	M207 P2 S0.8 F2000 T1000 Z0.25
