...
if !move.axes[0].homed || !move.axes[1].homed || !move.axes[2].homed || !move.axes[4].homed
	M291 T5 P"Please home axes before a tool change" R"Cannot change tool"
...
if state.previousTool < #global.ToolDock_X && state.previousTool < #global.ToolDock_Y && state.previousTool >= 0
	...
	abort "Cannot change tool - var.dockXpos and var.dockYpos was not set (unknown toolNum or toolNum out of bound)"
...
G53 G0 X{var.dockXpos} Y55 F40000       ; move to location
